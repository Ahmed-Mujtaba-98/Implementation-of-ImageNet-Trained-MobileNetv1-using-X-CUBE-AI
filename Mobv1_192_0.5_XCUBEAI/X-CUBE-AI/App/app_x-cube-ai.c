...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_CNN_MODEL_NAME,
        .config = AI_CNN_DATA_CONFIG,
        .ai_get_report = ai_cnn_get_report,
        .ai_create = ai_cnn_create,
        .ai_destroy = ai_cnn_destroy,
        .ai_get_error = ai_cnn_get_error,
        .ai_init = ai_cnn_init,
        .ai_run = ai_cnn_run,
        .ai_forward = ai_cnn_forward,
        .ai_data_params_get = ai_cnn_data_params_get,
