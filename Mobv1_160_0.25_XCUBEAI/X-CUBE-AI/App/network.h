...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mobilenet_v1_0_25_160_quant"
...
#define AI_NETWORK_IN_1_HEIGHT      (160)
#define AI_NETWORK_IN_1_WIDTH       (160)
#define AI_NETWORK_IN_1_CHANNEL     (3)
#define AI_NETWORK_IN_1_SIZE        (160 * 160 * 3)
#define AI_NETWORK_IN_1_SIZE_BYTES  (76801)
...
#define AI_NETWORK_OUT_1_CHANNEL     (1001)
#define AI_NETWORK_OUT_1_SIZE        (1 * 1 * 1001)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (1001)
